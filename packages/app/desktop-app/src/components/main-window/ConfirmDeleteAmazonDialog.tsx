...
import { removePresentAmazonAsin } from "../../slices/asinDataListSlice";

const ConfirmDeleteAmazonDialog = ({
  isOpenConfirmDeleteAmazonDialog: isOpenDialog,
  setIsOpenConfirmDeleteAmazonDialog: setIsOpenDialog,
}: ConfirmDeleteAmazonDialogProps) => {
  ...
  /// Amazonの出品してるAsinリストを削除して
  /// ストレージを最新に更新する関数
  const handleRemoveIsAmazonAsin = async () => {
    dispatch(removePresentAmazonAsin());
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            <p>Amazonの出品しているASINを全て削除してよいですか？?</p>
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button
...
export default ConfirmDeleteAmazonDialog;
